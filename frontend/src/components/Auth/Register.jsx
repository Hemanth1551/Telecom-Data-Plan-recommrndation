...
function Register() {
    ...
    try {
      ...
      if (res.ok) {
        ...
        alert(`Not registered ❌ : ${data.error || "Unknown error"}`);
      }
    } catch (err) {
        ...
        <div className="w-full px-4">
          <div className="relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white px-10 py-16 text-center sm:px-12 md:px-[60px] dark:bg-dark-2">
            <div className="mb-10 text-center md:mb-16">
              ...
              >
                <img src="https://upload.wikimedia.org/wikipedia/en/b/b6/Lumen_Technologies_Logo.png"
                  alt="logo"
                />
              </a>
            </div>
            ...
            <p className="text-base text-body-color dark:text-dark-6">
              <span className="pr-0.5">If you have already account ?</span>
              <a
                href="/login"
